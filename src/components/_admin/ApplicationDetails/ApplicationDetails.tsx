                            ...
                            <div className={styles.profileSection}>
                                ...
                                <div className={styles.basicInfo}>
                                    <div>
                                        ...
                                        <div className={styles.infoValue}>Sarah Johnson</div>
                                    </div>
                                    <div>
                                        <label className={styles.infoLabel}>Date of Birth</label>
                                        <div className={styles.infoValue}>March 15, 1995</div>
                                    </div>
                                    <div>
                                        <label className={styles.infoLabel}>Date of Birth</label>
                                        <div className={styles.infoValue}>March 15, 1995</div>
                                    ...
                                    <div>
                                        ...
                                        <div className={styles.infoValue}>January 12, 2024</div>
                                    </div>
                                    <div className={styles.fullWidth}>
                                        <label className={styles.infoLabel}>Email Address</label>
                                        <div className={styles.infoValue}>sarah.johnson@email.com</div>
                                    </div>
                                    <div>
                                ...
                                <div className={styles.actions}>
                                    ...
                                    <Button className={`${styles.actionBtn} ${styles.continue}`}>
                                        <FiCheck size={20} />
                                        <span>Continue</span>
                                    </Button>
                                </div>
