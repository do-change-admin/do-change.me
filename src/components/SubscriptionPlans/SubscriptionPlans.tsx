...
import { FaCar, FaCheck, FaFileAlt, FaShieldAlt, FaHeadset, FaRocket, FaCrown, FaGavel, FaShareAlt, FaStar, FaInfoCircle, FaUnlock, FaLock } from "react-icons/fa";
                        ...
                        <div className={styles.cardContent}>
                            ...
                            <div className={styles.features}>
                                <div className={styles.feature}>
                                    ...
                                    <div>
                                        <strong>Market Value</strong> — <Badge size="lg" variant="light">Unlimited</Badge>
                                        <p className={styles.featureNote}>Get accurate market pricing for any vehicle</p>
                                    </div>
                                </div>
                                <div className={styles.feature}>
                                    <FaCheck className={styles.checkGreen} />
                                    <div>
                                        <strong>Total Loss Check</strong> — <Badge size="lg" variant="light">Unlimited</Badge>
                                ...
                                <div className={styles.feature}>
                                    ...
                                    <div>
                                        ...
                                        <p className={styles.featureNote}>The best report options, such as Carfax and AutoCheck.</p>
                                ...
                                <div className={styles.feature}>
                                    ...
                                    <div>
                                        ...
                                        <p className={styles.featureNote}>Advanced algorithms to detect potential fraud</p>
                                    </div>
                                </div>
                                <div className={styles.feature}>
                        ...
                        <div className={styles.cardContent}>
                            ...
                            <div className={styles.features}>
                                ...
                                <div className={styles.feature}>
                                    ...
                                    <div>
                                        ...
                                        <p className={styles.featureNote}>Distribute your inventory across multiple platforms</p>
                                    </div>
                                </div>
                                <div className={styles.feature}>
                                    <FaFileAlt className={styles.iconBlue} />
                            ...
                            <div className={styles.auctionBox}>
                                ...
                                <p className={styles.auctionText}>
                                    You will go through several verification steps to obtain Auction Access. After completing these steps, you will be able to subscribe to this plan. You'll gain access to dealer auctions and will be able to purchase vehicles after Auction Access is approved.
                                </p>
                            </div>
