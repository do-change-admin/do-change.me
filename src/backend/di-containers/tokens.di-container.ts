export const StoreTokens = {
    ...
    vehicleHistoryReportsCache: Symbol.for(
        "VEHICLE-HISTORY-REPORTS-CACHE-DATA-PROVIDER"
    ),
...
export const ServiceTokens = {
    ...
    syndicationRequestDraftsFactory: Symbol.for(
        "SYNDICATION-REQUEST-DRAFTS-SERVICE-FACTORY"
    ),
    syndicationRequestManagement: Symbol.for(
        "SYNDICATION-REQUEST-MANAGEMENT-SERVICE"
    ),
    userNotificationsFactory: Symbol.for("USER-NOTIFICATIONS-SERVICE"),
    userNotificationsManagementFactory: Symbol.for(
        "USER-NOTIFICATIONS-MANAGEMENT-SERVICE"
    ),
};

export const ControllerTokens = {
    syndicationRequests: Symbol.for("SYNDICATION-REQUESTS-CONTROLLER"),
    syndicationRequestDrafts: Symbol.for(
        "SYNDICATION-REQUEST-DRAFTS-CONTROLLER"
    ),
    syndicationRequestManagement: Symbol.for(
        "SYNDICATION-REQUEST-MANAGEMENT-CONTROLLER"
    ),
    userNotifications: Symbol.for("USER-NOTIFICATIONS-CONTROLLER"),
    userNotificationsManagement: Symbol.for(
        "USER-NOTIFICATIONS-MANAGEMENT-CONTROLLER"
    ),
