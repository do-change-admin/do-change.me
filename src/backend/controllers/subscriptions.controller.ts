...
import z from 'zod';
import { type ZodController, type ZodControllerSchemas, zodApiMethod } from '../DEPRECATED-HELPERS/zod-api-controller.utils____DEPRECATED';
...
const schemas = {
    CurrentInfo_GET: {
        ...
        query: undefined,
        response: z.object({
            level: z.enum(['no subscription', 'basic plan', 'premium plan']),
            isAdmin: z.boolean()
        })
    }
