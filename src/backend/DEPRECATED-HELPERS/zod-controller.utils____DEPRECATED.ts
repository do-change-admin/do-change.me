...
import { type ControllerErrorModel, type ErrorBaseCreatingPayload, ErrorFactory } from '@/value-objects/errors.value-object';
...
export function ZodController<T extends ZodControllerSchemas>(name: string, schemas: T) {
