...
type ErrorResponse = {
    ...
    stage: 'query params parsing' | 'request body parsing' | 'result parsing' | 'api handler executing' | 'user obtaining';
    success: false;
};
...
>(
    ...
    return async (request: NextRequest) => {
        ...
        if (schemas.query) {
            ...
            const queryParamsParsed = schemas.query.safeParse(queryParamsAsObject);
        ...
        try {
            ...
            const flags: Parameters<(typeof logic)['handler']>[0]['flags'] = {};
...
>(
    ...
    return async (request: NextRequest) => {
        ...
        try {
            ...
            const result = await handler(resultObject as Parameters<typeof handler>[0], request);
            if (returnDataSchema) {
